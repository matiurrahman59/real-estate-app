...
interface NearbyEstatesProps {
  nearbyEstateList: nearbyEstate[];
}

const NearbyEstates: FC<NearbyEstatesProps> = ({ nearbyEstateList }) => {
  const router = useRouter();
  return (
    <FlatList
      data={nearbyEstateList}
      scrollEnabled={false}
      numColumns={2}
      columnWrapperStyle={{
